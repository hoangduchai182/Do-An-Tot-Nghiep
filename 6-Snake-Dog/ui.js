export class Ui {
  constructor(game) {
    ...
    this.debugtButton = document.getElementById("debugtButton");
    this.debugtButton.addEventListener("click", () => {
  ...
  triggerGameOver(winner) {
    ...
    if (winner) {
      if (
        this.game.player1.type === "player" &&
        this.game.player1.name === winner.name
      ) {
        ScoreSnakeDog(this.game.player1.score);
      }
      ...
      this.message1.innerText = "WelCome to the Battle !";
      this.message2.innerText = "Choose your character";
    }
  }
