...
function addGame() {
  ...
  const game6 = new Games(
    "snakedog",
    "Snake Dog",
    "../images/logo-Snake-Dog.png",
    "../6-Snake-Dog/Snake-dog.html",
    "../6-Snake-Dog/Snake-dog.html",
    "Chào mừng đến với Thung Lũng Hòa Bình - nơi mà cuộc sống của các chú chó không chỉ là việc thức ăn, mà còn là cuộc đua sinh tồn giữa những kẻ săn mồi lừng danh. Trong trò chơi Snake Dog, bạn sẽ bước vào vai một chú chó dũng cảm, sẵn sàng thách thức vận may và khám phá thế giới hoang dã đầy mạo hiểm này.",
    [],
    [],
    0
  );
  ...
  function addGameIfNotExists(game) {
    ...
    const existingGame = gameArr.find(
      (existing) => existing.name === game.name
    );
  ...
  game6.genres.push("Trẻ con", "Hài hước");
